...
import indi.aljet.mycrash_master.IMyAidlInterface_1;
import indi.aljet.mycrash_master.MainActivity;

public class IMyAidlInterface1 extends Service {

    private String TAG = getClass().getName();

    private String Process_Name = "indi.aljet.mycrash_master:IMyAidlInterface2";
    private boolean isCrash;

    private IMyAidlInterface_1 service_1 = new
            IMyAidlInterface_1.Stub() {
                @Override
                public void startService() throws RemoteException {
                    Intent i = new Intent(IMyAidlInterface1.this,
    ...
    public void onCreate() {
        Log.e("indi.service1 ","开启服务 1");
        new Thread(){
            public void run(){
                while(true){
                    boolean isRun = isProcessRunning
                            (IMyAidlInterface1.this,
                                    Process_Name);
                    if(!isRun){
                        try{
                            Log.i(TAG,"重新开启服务2: "
                    ...
                    if(isCrash){
                        ...
                        Intent intent = new Intent(IMyAidlInterface1
